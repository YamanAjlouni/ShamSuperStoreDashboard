...
const WebsiteAdminSidebar = ({ isCollapsed, isMobile, isOpen, onClose }) => {
    ...
    const menuItems = [
        ...
        },
        {
            ...
            label: 'Media Library',
            active: location.pathname.includes('/media')
        },
        {
            path: '/websiteAdmin/seo',
            icon: (
                <svg fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            active: location.pathname.includes('/seo')
        },
        {
            path: '/websiteAdmin/general-settings',
            icon: (
                <svg fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            label: 'Settings',
            active: location.pathname.includes('/general-settings') || location.pathname.includes('/settings')
        }
    ]
