        ...
        <div className="accountant-settings">
            ...
            <div className="readonly-notice">
                ...
                <div className="notice-content">
                    ...
                    <p>
                        As an accountant, you have read-only access to these settings.
                        To modify any configuration, please contact your system administrator
                        or use the "Contact Admin" button above.
                    </p>
                </div>
            </div>
        </div>
